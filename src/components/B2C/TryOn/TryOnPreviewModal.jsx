        ...
        <div>
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full bg-primary hover:bg-hoverBg cursor-pointer text-white py-2.5  transition-all font-medium flex items-center justify-center gap-2 text-sm"
            >
                ...
                {colors.map((color) => (
                  <button
                    ...
                    className={`aspect-square rounded-lg ${
                      selectedColor === color.name ? 'ring-2 ring-gray-800 ring-offset-2' : 'border border-gray-200'
                    }`}
                    style={{ backgroundColor: color.color }}
                  />
                ))}
              ...
              {backgroundOptions.map((bg) => (
                <button
                  ...
                  className={`relative rounded-lg overflow-hidden ${
                    selectedBackground === bg.id ? 'ring-2 ring-gray-800 ring-offset-2' : 'border border-gray-200'
